...
public:
    ...
    TriangleSet(T eps_);
    TriangleSet(std::vector<Triangle> const& triangles_, Precision precision_ = DBL);
    TriangleSet(std::vector<Triangle> const& triangles_, T eps_);
    ...
    void writeAsciiSTL(std::string fname, int numDecimalDigits = 10) const;
