...
template<typename T>
FreeSlipProfile3D<T>* 
    FreeSlipProfile3D<T>::clone() const
{
...
template<typename T>
PoiseuilleProfile3D<T>*
    PoiseuilleProfile3D<T>::clone() const
{
...
template< typename T, template<typename U> class Descriptor>
IncreasingPoiseuilleProfile3D<T,Descriptor>*
    IncreasingPoiseuilleProfile3D<T,Descriptor>::clone() const
{
...
template< typename T, template<typename U> class Descriptor>
IncreasingVelocityProfile3D<T,Descriptor>*
...
template< typename T, template<typename U> class Descriptor>
TimeDependentVelocityProfile3D<T,Descriptor>& TimeDependentVelocityProfile3D<T,Descriptor>::operator=
        (TimeDependentVelocityProfile3D<T,Descriptor> const& rhs)
{
...
template< typename T, template<typename U> class Descriptor>
void TimeDependentVelocityProfile3D<T,Descriptor>::swap(TimeDependentVelocityProfile3D<T,Descriptor>& rhs)
{
...
template<typename T>
ConstantVelocityProfile3D<T>::ConstantVelocityProfile3D(Array<T,3> const& u_)
    : u(u_)
{ }
...
ConstantVelocityProfile3D<T>*
    ConstantVelocityProfile3D<T>::clone() const
{
...
template<typename T>
VelocityPlugProfile3D<T>::VelocityPlugProfile3D(T uMax_)
    : uMax(uMax_),
      normal(T(),T(),T())
{ }
...
template<typename T>
VelocityPlugProfile3D<T>*
    VelocityPlugProfile3D<T>::clone() const
{
...
template<typename T>
void NeumannBoundaryProfile3D<T>::defineCircularShape (
        Array<T,3> const& center_, T radius_ )
{ }
...
template<typename T>
NeumannBoundaryProfile3D<T>* 
    NeumannBoundaryProfile3D<T>::clone() const
{
...
template<typename T>
DensityNeumannBoundaryProfile3D<T>::DensityNeumannBoundaryProfile3D(T rho_)
    : rho(rho_)
{ }
...
DensityNeumannBoundaryProfile3D<T>* 
    DensityNeumannBoundaryProfile3D<T>::clone() const
{
...
template<typename T>
ScalarDirichletProfile3D<T>::ScalarDirichletProfile3D(T value_)
    : value(value_)
{ }
...
template<typename T>
void ScalarDirichletProfile3D<T>::defineCircularShape (
        Array<T,3> const& center_, T radius_ )
{ }
...
template<typename T>
ScalarDirichletProfile3D<T>* 
    ScalarDirichletProfile3D<T>::clone() const
{
...
template<typename T>
void ScalarNeumannProfile3D<T>::defineCircularShape (
        Array<T,3> const& center_, T radius_ )
{ }
...
template<typename T>
ScalarNeumannProfile3D<T>* 
    ScalarNeumannProfile3D<T>::clone() const
{
...
template<typename T>
ScalarFluxProfile3D<T>::ScalarFluxProfile3D(T gradVal_)
    : gradVal(gradVal_)
{ }
...
template<typename T>
void ScalarFluxProfile3D<T>::defineCircularShape (
        Array<T,3> const& center_, T radius_ )
{ }
...
template<typename T>
ScalarFluxProfile3D<T>* 
    ScalarFluxProfile3D<T>::clone() const
{
...
template<typename T>
void ScalarIsolationProfile3D<T>::defineCircularShape (
        Array<T,3> const& center_, T radius_ )
{ }
...
template<typename T>
ScalarIsolationProfile3D<T>* 
    ScalarIsolationProfile3D<T>::clone() const
{
