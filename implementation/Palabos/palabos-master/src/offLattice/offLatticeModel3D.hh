...
template<typename T, class SurfaceData>
void OffLatticeModel3D<T,SurfaceData>::provideShapeArguments (
...
template< typename T, class SurfaceData >
GetForceOnObjectFunctional3D<T,SurfaceData>*
    GetForceOnObjectFunctional3D<T,SurfaceData>::clone() const
{
     return new GetForceOnObjectFunctional3D<T,SurfaceData>(*this);
}

template< typename T, class SurfaceData >
void GetForceOnObjectFunctional3D<T,SurfaceData>::getTypeOfModification(std::vector<modif::ModifT>& modified) const
{
