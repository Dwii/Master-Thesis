...
FullDomainCollideAndStreamAction3D<T,Descriptor>::FullDomainCollideAndStreamAction3D(plint blockId_)
    : blockId(blockId_)
{ }

template<typename T, template<typename U> class Descriptor>
FullDomainCollideAndStreamAction3D<T,Descriptor>* FullDomainCollideAndStreamAction3D<T,Descriptor>::clone() const {
...
template<typename T, template<typename U> class Descriptor>
IncrementTimeAction3D<T,Descriptor>::IncrementTimeAction3D(plint blockId_)
    : blockId(blockId_)
{ }
