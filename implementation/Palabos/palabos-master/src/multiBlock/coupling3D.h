...
class Coupling3D {
public:
    Coupling3D( DataProcessorGenerator3D* generator_,
...
public:
    ReductiveCoupling3D( ReductiveDataProcessorGenerator3D* generator_,
                         std::vector<plint> const& multiBlocks_, // Local ID (0, 1, 2, ...) inside Actions3D of
                                                                 // multi-blocks to be coupled.
                         std::vector<id_t>& allMultiBlocks );    // Global ID of all multi-blocks inside Actions3D.
    ~ReductiveCoupling3D();
...
public:
    ...
    plint addProcessor(BoxProcessingFunctional3D* functional, std::vector<plint> blockNums, Box3D domain);
    plint addProcessor(BoxProcessingFunctional3D* functional, std::vector<plint> blockNums,
                                                              std::vector<Box3D> const& domains);
    plint addProcessor(BoxProcessingFunctional3D* functional, plint blockNum1, Box3D domain);
    plint addProcessor(BoxProcessingFunctional3D* functional, plint blockNum1,
                       std::vector<Box3D> const& domains);
    plint addProcessor(BoxProcessingFunctional3D* functional, plint blockNum1,
                       plint blockNum2, Box3D domain);
    plint addProcessor(BoxProcessingFunctional3D* functional, plint blockNum1,
                       plint blockNum2, std::vector<Box3D> const& domains);
    plint addProcessor(BoxProcessingFunctional3D* functional, plint blockNum1,
                       plint blockNum2, plint blockNum3, Box3D domain);
    plint addProcessor(BoxProcessingFunctional3D* functional, plint blockNum1,
                       plint blockNum2, plint blockNum3, std::vector<Box3D> const& domains);
    plint addProcessor(BoxProcessingFunctional3D* functional, plint blockNum1,
                       plint blockNum2, plint blockNum3, plint blockNum4, Box3D domain);
    plint addProcessor(BoxProcessingFunctional3D* functional, plint blockNum1,
                       plint blockNum2, plint blockNum3, plint blockNum4, plint blockNum5, Box3D domain);
    plint addProcessor(ReductiveBoxProcessingFunctional3D* functional,
