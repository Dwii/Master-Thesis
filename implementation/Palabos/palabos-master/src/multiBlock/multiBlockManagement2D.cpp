...
MultiBlockManagement2D extend( MultiBlockManagement2D const& management,
...
MultiBlockManagement2D block_union( MultiBlockManagement2D const& management1,
                                    MultiBlockManagement2D const& management2 )
{
    std::map<plint,std::vector<plint> > remappedIds;
    SparseBlockStructure2D resultStructure =
                              ...
                              MultiBlockManagement2D const& partnerManagement )
{
    ...
    SparseBlockStructure2D resultStructure =
        alignDistribution2D(originalManagement.getSparseBlockStructure(),
...
SmartBulk2D::SmartBulk2D( MultiBlockManagement2D const& management,
                          plint blockId )
...
SmartBulk2D::SmartBulk2D( SparseBlockStructure2D const& sparseBlock_,
...
Box2D SmartBulk2D::computeNonPeriodicEnvelope() const
{
    ...
    return Box2D ( std::max(bulk.x0-envelopeWidth, boundingBox.x0),
