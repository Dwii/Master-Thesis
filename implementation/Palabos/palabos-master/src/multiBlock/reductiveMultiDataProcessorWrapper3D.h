...
void applyProcessingFunctional (
        ...
        Box3D domain, std::vector<MultiNTensorField3D<T>*> fields,
        plint boundaryWidth );
...
template<typename T>
void applyProcessingFunctional(BoundedReductiveBoxProcessingFunctional3D_N<T>& functional,
                               Box3D domain, MultiNTensorField3D<T>& field,
                               plint boundaryWidth);

template<typename T>
void applyProcessingFunctional(BoundedMaskedReductiveBoxProcessingFunctional3D_N<T>& functional,
                               Box3D domain,
                               MultiNTensorField3D<T>& field,
                               MultiNTensorField3D<int>& mask,
                               plint boundaryWidth);
