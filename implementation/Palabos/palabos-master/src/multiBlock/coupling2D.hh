...
FullDomainCollideAndStreamAction2D<T,Descriptor>::FullDomainCollideAndStreamAction2D(plint blockId_)
    : blockId(blockId_)
{ }

template<typename T, template<typename U> class Descriptor>
FullDomainCollideAndStreamAction2D<T,Descriptor>* FullDomainCollideAndStreamAction2D<T,Descriptor>::clone() const {
...
template<typename T, template<typename U> class Descriptor>
IncrementTimeAction2D<T,Descriptor>::IncrementTimeAction2D(plint blockId_)
    : blockId(blockId_)
{ }
