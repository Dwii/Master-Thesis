...
int RLBdynamics<T,Descriptor>::id =
    meta::registerCompositeDynamics<T,Descriptor, RLBdynamics<T,Descriptor> >("Regularized_generic");

/** \param omega_ relaxation parameter, related to the dynamic viscosity
 */
template<typename T, template<typename U> class Descriptor>
RLBdynamics<T,Descriptor>::RLBdynamics(Dynamics<T,Descriptor>* baseDynamics, bool automaticPrepareCollision)
...
template<typename T, template<typename U> class Descriptor>
T ExternalMomentRegularizedBGKdynamics<T,Descriptor>::computeRhoBar(Cell<T,Descriptor> const& cell) const
{
    return momentTemplates<T,Descriptor>::get_rhoBar(cell);
}
...
template<typename T, template<typename U> class Descriptor>
T PrecondBGKdynamics<T,Descriptor>::computeEquilibrium(plint iPop, T rhoBar, Array<T,Descriptor<T>::d> const& j,
                                                T jSqr, T thetaBar) const
{
    T invRho = Descriptor<T>::invRho(rhoBar);
