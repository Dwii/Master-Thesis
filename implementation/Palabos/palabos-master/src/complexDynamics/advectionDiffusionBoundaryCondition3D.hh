...
template<typename T, template<typename U> class Descriptor>
template<int direction, int orientation>
BoundaryCompositeDynamics<T,Descriptor>* RegularizedAdvectionDiffusionBoundaryManager3D<T,Descriptor>::
    getTemperatureBoundaryDynamics(Dynamics<T,Descriptor>* baseDynamics)
{
    return new RegularizedAdvectionDiffusionBoundaryDynamics
                   <T,Descriptor,direction,orientation>(baseDynamics);
}
...
template<int direction, int orientation>
BoxProcessingFunctional3D_L<T,Descriptor>*
    RegularizedAdvectionDiffusionBoundaryManager3D<T,Descriptor>::
        getTemperatureBoundaryProcessor(Box3D domain)
{
    return 0;
}
...
template<typename T, template<typename U> class Descriptor>
template<int direction, int orientation>
BoundaryCompositeDynamics<T,Descriptor>* CompleteRegularizedAdvectionDiffusionBoundaryManager3D<T,Descriptor>::
    getTemperatureBoundaryDynamics(Dynamics<T,Descriptor>* baseDynamics)
{
...
BoxProcessingFunctional3D_L<T,Descriptor>*
    CompleteRegularizedAdvectionDiffusionBoundaryManager3D<T,Descriptor>::
        getTemperatureEdgeProcessor(Box3D domain)
{
    return new CompleteAdvectionDiffusionEdgeBoundaryFunctional3D<T,Descriptor,plane,normal1,normal2>();
}
...
BoxProcessingFunctional3D_L<T,Descriptor>*
    CompleteRegularizedAdvectionDiffusionBoundaryManager3D<T,Descriptor>::
        getTemperatureCornerProcessor(plint x, plint y, plint z)
{
    return new CompleteAdvectionDiffusionCornerBoundaryFunctional3D<T,Descriptor,xNormal,yNormal,zNormal>();
}
