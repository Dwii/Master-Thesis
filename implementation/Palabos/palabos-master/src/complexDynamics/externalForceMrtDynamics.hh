        ...
        Cell<T,Descriptor>& cell, BlockStatistics& statistics )
{
    ...
    T jSqr = mrtTemp::incSmagorinskyMrtCollisionWithForce(cell, rhoBar, u, S, cSmago, this->getOmega(), (T)1);
...
template<typename T, template<typename U> class Descriptor>
int GuoExternalForceAndMomentMRTdynamics<T,Descriptor>::id =
    meta::registerGeneralDynamics<T,Descriptor,GuoExternalForceAndMomentMRTdynamics<T,Descriptor> >("MRT_ExternalForceAndMoment_Guo");

template<typename T, template<typename U> class Descriptor>
GuoExternalForceAndMomentMRTdynamics<T,Descriptor>::GuoExternalForceAndMomentMRTdynamics(T omega_)
    : ExternalForceDynamics<T,Descriptor>(omega_)
{ } 

template<typename T, template<typename U> class Descriptor>
GuoExternalForceAndMomentMRTdynamics<T,Descriptor>::GuoExternalForceAndMomentMRTdynamics(HierarchicUnserializer& unserializer)
    : ExternalForceDynamics<T,Descriptor>(T())
{
    this->unserialize(unserializer);
}
...
template<typename T, template<typename U> class Descriptor>
GuoExternalForceAndMomentMRTdynamics<T,Descriptor>* GuoExternalForceAndMomentMRTdynamics<T,Descriptor>::clone() const {
...
int HeExternalForceMRTdynamics<T,Descriptor>::id =
    meta::registerGeneralDynamics<T,Descriptor,HeExternalForceMRTdynamics<T,Descriptor> >("MRT_ExternalForce_He");
...
template<typename T, template<typename U> class Descriptor>
HeExternalForceMRTdynamics<T,Descriptor>::HeExternalForceMRTdynamics(HierarchicUnserializer& unserializer)
    : ExternalForceDynamics<T,Descriptor>(T())
{
    this->unserialize(unserializer);
}
