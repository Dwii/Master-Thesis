...
int BoundaryCompositeDynamics<T,Descriptor>::id =
    meta::registerCompositeDynamics<T,Descriptor, BoundaryCompositeDynamics<T,Descriptor> >("Boundary_Composite");
...
int StoreDensityDynamics<T,Descriptor>::id =
    meta::registerGeneralDynamics<T,Descriptor, StoreDensityDynamics<T,Descriptor> >("Boundary_StoreDensity");
...
int StoreVelocityDynamics<T,Descriptor>::id =
    meta::registerGeneralDynamics<T,Descriptor, StoreVelocityDynamics<T,Descriptor> >("Boundary_StoreVelocity");
...
int StoreDensityAndVelocityDynamics<T,Descriptor>::id =
    meta::registerGeneralDynamics<T,Descriptor, StoreDensityAndVelocityDynamics<T,Descriptor> >("Boundary_StoreDensityAndVelocity");
...
template<typename T, template<typename U> class Descriptor>
int StoreTemperatureAndVelocityDynamics<T,Descriptor>::id =
    meta::registerGeneralDynamics<T,Descriptor, StoreTemperatureAndVelocityDynamics<T,Descriptor> >
...
int VelocityDirichletBoundaryDynamics<T,Descriptor,direction,orientation>::id =
    meta::registerGeneralDynamics<T,Descriptor, VelocityDirichletBoundaryDynamics<T,Descriptor,direction,orientation> >
            ( std::string("Boundary_VelocityDirichlet_")+util::val2str(direction) +
              std::string("_")+util::val2str(orientation) );

template<typename T, template<typename U> class Descriptor,
         int direction, int orientation>
VelocityDirichletBoundaryDynamics<T,Descriptor,direction,orientation>::
    VelocityDirichletBoundaryDynamics(Dynamics<T,Descriptor>* baseDynamics_, bool automaticPrepareCollision_)
...
int DensityDirichletBoundaryDynamics<T,Descriptor,direction,orientation>::id =
    meta::registerGeneralDynamics<T,Descriptor, DensityDirichletBoundaryDynamics<T,Descriptor,direction,orientation> > (
            std::string("Boundary_DensityDirichlet_")+util::val2str(direction) +
            std::string("_")+util::val2str(orientation) );

template<typename T, template<typename U> class Descriptor,
         int direction, int orientation>
DensityDirichletBoundaryDynamics<T,Descriptor,direction,orientation>::
    DensityDirichletBoundaryDynamics(Dynamics<T,Descriptor>* baseDynamics_, bool automaticPrepareCollision_)
