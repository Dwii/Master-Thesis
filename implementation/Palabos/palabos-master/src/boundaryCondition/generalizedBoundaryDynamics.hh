...
int GeneralizedVelocityBoundaryDynamics<T,Descriptor>::id =
    meta::registerGeneralDynamics<T,Descriptor,GeneralizedVelocityBoundaryDynamics<T,Descriptor> >
...
template<typename T, template<typename U> class Descriptor>
void GeneralizedVelocityBoundaryDynamics<T,Descriptor>::
    computeUlb(Cell<T,Descriptor> const& cell, Array<T,Descriptor<T>::d> &uLb) const {
...
int GeneralizedMassConservingVelocityBoundaryDynamics<T,Descriptor>::id =
    meta::registerGeneralDynamics<T,Descriptor,GeneralizedMassConservingVelocityBoundaryDynamics<T,Descriptor> >
...
GeneralizedMassConservingVelocityBoundaryDynamics<T,Descriptor>::
    GeneralizedMassConservingVelocityBoundaryDynamics(Dynamics<T,Descriptor>* baseDynamics_,
                                        ...
                                        bool automaticPrepareCollision)
        : StoreVelocityDynamics<T,Descriptor>(baseDynamics_,automaticPrepareCollision),
            missingIndices(missingIndices_), knownIndices(knownIndices_), inGoingIndices(inGoingIndices_)
{  }
...
template<typename T, template<typename U> class Descriptor>
void GeneralizedMassConservingVelocityBoundaryDynamics<T,Descriptor>::
    computeUlb(Cell<T,Descriptor> const& cell, Array<T,Descriptor<T>::d> &uLb) const {
    ...
    completePopulations(Cell<T,Descriptor>& cell) const
{
    ...
    DirichletMassConservingVelocityBoundarySolver<T,Descriptor> bc(missingIndices, knownIndices, 
                                                                   inGoingIndices, uLb);
    bc.apply(cell,this->getBaseDynamics());
}
...
int GeneralizedDensityBoundaryDynamics<T,Descriptor,direction,orientation>::id =
    meta::registerGeneralDynamics<T,Descriptor, GeneralizedDensityBoundaryDynamics<T,Descriptor,direction,orientation> >
            ( std::string("Boundary_GeneralizedDensity_")+util::val2str(direction) +
...
template<typename T, template<typename U> class Descriptor,
         int direction, int orientation>
void GeneralizedDensityBoundaryDynamics<T,Descriptor,direction,orientation>::
    completePopulations(Cell<T,Descriptor>& cell) const
{
    T rhoBar;
    ...
    DirichletDensityBoundarySolver<T,Descriptor,direction> bc(missingIndices, knownIndices, rho, u, PiNeq, 1.0e-7);
    bc.apply(cell,this->getBaseDynamics());
...
int GeneralizedVelocityTemperatureBoundaryDynamics<T,Descriptor>::id =
    meta::registerGeneralDynamics<T,Descriptor,GeneralizedVelocityTemperatureBoundaryDynamics<T,Descriptor> >
...
GeneralizedVelocityTemperatureBoundaryDynamics<T,Descriptor>::
    GeneralizedVelocityTemperatureBoundaryDynamics(Dynamics<T,Descriptor>* baseDynamics_,
                                        std::vector<plint> missingIndices_, bool massConserving_,
                                        bool automaticPrepareCollision)
        : StoreTemperatureAndVelocityDynamics<T,Descriptor>(baseDynamics_,automaticPrepareCollision),
          missingIndices(missingIndices_), massConserving(massConserving_)
{ 
    knownIndices = indexTemplates::remainingIndexes<Descriptor<T> >(missingIndices);
}
...
GeneralizedVelocityTemperatureBoundaryDynamics<T,Descriptor>::
    GeneralizedVelocityTemperatureBoundaryDynamics(Dynamics<T,Descriptor>* baseDynamics_,
                                        std::vector<plint> missingIndices_, std::vector<plint> knownIndices_, 
                                        bool massConserving_,
                                        bool automaticPrepareCollision)
        : StoreTemperatureAndVelocityDynamics<T,Descriptor>(baseDynamics_,automaticPrepareCollision),
            missingIndices(missingIndices_), knownIndices(knownIndices_), massConserving(massConserving_)
{  }
...
template<typename T, template<typename U> class Descriptor>
void GeneralizedVelocityTemperatureBoundaryDynamics<T,Descriptor>::
    computeUlb(Cell<T,Descriptor> const& cell, Array<T,Descriptor<T>::d> &uLb) const {
...
//         solveLinearSystemTrLessPiNeq(cell, uLb, thetaBar,missingIndices, knownIndices, rho, PiNeq, qNeq, massConserving);
        
    generalizedComprTempBoundaryTemplates<T,Descriptor>::
        solveLinearSystem(cell, uLb, thetaBar,missingIndices, knownIndices, rho, PiNeq, qNeq, massConserving);
...
GeneralizedNextToBoundaryDynamics<T,Descriptor>::
    GeneralizedNextToBoundaryDynamics(Dynamics<T,Descriptor>* baseDynamics_,
                                      ...
                                      bool automaticPrepareCollision)
        : BoundaryCompositeDynamics<T,Descriptor>(baseDynamics_,automaticPrepareCollision),
            missingIndices(missingIndices_), knownIndices(knownIndices_)
{  }
...
template<typename T, template<typename U> class Descriptor>
void GeneralizedNextToBoundaryDynamics<T,Descriptor>::
    completePopulations(Cell<T,Descriptor>& cell) 
{
    
    T epsilon = 1.0e-10;
    T resSum;
    bool converged = generalizedComprTempBoundaryTemplates<T,Descriptor>::
        iterativelySolveSystem(cell, rho, u, thetaBar, PiNeq, Qneq, knownIndices, missingIndices, epsilon, resSum);
//     bool converged = generalizedComprTempBoundaryTemplates<T,Descriptor>::
//         iterativelySolveSystemTrLessPiNeq(cell, rho, u, thetaBar, PiNeq, Qneq, knownIndices, missingIndices, epsilon, resSum);
    if (!converged) {
