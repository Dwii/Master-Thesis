...
Particle2D<T,Descriptor>::Particle2D()
    : tag(0),
      position(T(),T())
{ }
...
template<typename T, template<typename U> class Descriptor>
PointParticle2D<T,Descriptor>::PointParticle2D(plint tag_, Array<T,2> const& position_, Array<T,2> const& velocity_)
...
int NormedVelocityParticle2D<T,Descriptor>::id =
        meta::registerGenericParticle2D<T,Descriptor,NormedVelocityParticle2D<T,Descriptor> >("NormedVelocity");
...
template<typename T, template<typename U> class Descriptor>
void VerletParticle2D<T,Descriptor>::velocityToParticle(TensorField2D<T,2>& velocityField, T scaling)
{
...
template<typename T, template<typename U> class Descriptor>
void VerletParticle2D<T,Descriptor>::fluidToParticle(BlockLattice2D<T,Descriptor>& fluid, T scaling)
{
    Array<T,2> position(this->getPosition());
    std::vector<Dot2D> pos(4);
    std::vector<T> weights(4);
...
int VerletGeryaParticle2D<T,Descriptor>::id =
        meta::registerGenericParticle2D<T,Descriptor,VerletGeryaParticle2D<T,Descriptor> >("VerletGerya");



template<typename T, template<typename U> class Descriptor>
VerletGeryaParticle2D<T,Descriptor>::VerletGeryaParticle2D()
    : VerletParticle2D<T,Descriptor>(),
      fluidConcentration((T)0)
{ }

template<typename T, template<typename U> class Descriptor>
VerletGeryaParticle2D<T,Descriptor>::VerletGeryaParticle2D(plint tag_, Array<T,2> const& position_, T fluidConcentration_)
    : VerletParticle2D<T,Descriptor>(tag_, position_),
