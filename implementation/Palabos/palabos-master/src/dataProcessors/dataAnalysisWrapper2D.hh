...
template<typename T, template<typename U> class Descriptor>
void computePiNeq(BlockLattice2D<T,Descriptor>& lattice,
...
template<typename T, template<typename U> class Descriptor>
void computeShearStress(BlockLattice2D<T,Descriptor>& lattice,
                             TensorField2D<T,SymmetricTensor<T,Descriptor>::n>& PiNeq)
{
    applyProcessingFunctional (
...
{
    applyProcessingFunctional (
    new BoxTemperatureFunctional2D<T,Descriptor>, lattice.getBoundingBox(), lattice, temperature );
}
...
{
    applyProcessingFunctional (
    new BoxSoundSpeedFunctional2D<T,Descriptor>, lattice.getBoundingBox(), lattice, soundSpeed );
}
...
template<typename T, template<typename U> class Descriptor>
void computeAllPopulations(BlockLattice2D<T,Descriptor>& lattice, 
...
template<typename T, template<typename U> class Descriptor>
void copyPopulations(BlockLattice2D<T,Descriptor>& latticeFrom, BlockLattice2D<T,Descriptor>& latticeTo,
                     Box2D domain)
{
    applyProcessingFunctional (
...
template<typename T, template<typename U> class Descriptor>
void copyAll(BlockLattice2D<T,Descriptor>& latticeFrom,
             BlockLattice2D<T,Descriptor>& latticeTo, Box2D domain)
{
    applyProcessingFunctional (
...
template<typename T, template<typename U> class Descriptor>
void copyRegenerate(BlockLattice2D<T,Descriptor>& latticeFrom,
                    BlockLattice2D<T,Descriptor>& latticeTo, Box2D domain)
{
    applyProcessingFunctional (
...
{
    applyProcessingFunctional (
    new ComputeScalarSqrtFunctional2D<T>, domain, A, result );
}
...
{
    applyProcessingFunctional (
    new ComputeAbsoluteValueFunctional2D<T>, domain, A, result );
}
...
{
    applyProcessingFunctional (
    new ComputeTensorSqrtFunctional2D<T, nDim>, domain, A, result );
}
...
{
    applyProcessingFunctional (
            new CopyConvertTensorFunctional2D<T1,T2,nDim>, field.getBoundingBox(), field, convertedField );
}
...
{
    applyProcessingFunctional (
            new Tensor_A_times_alpha_functional2D<T,nDim>(scalar), field.getBoundingBox(), field, result );
}
...
template<typename T, template<typename U> class Descriptor>
void computeRhoBarJ( MultiBlockLattice2D<T,Descriptor>& lattice,
                     MultiScalarField2D<T>& rhoBar, MultiTensorField2D<T,2>& j, Box2D domain )
{
...
template<typename T, template<typename U> class Descriptor>
void computeEquilibrium(MultiBlockLattice2D<T,Descriptor>& lattice, MultiScalarField2D<T>& equilibrium,
                        Box2D domain, plint iPop)
{
    applyProcessingFunctional (
...
template<typename T, template<typename U> class Descriptor>
void copyPopulations(MultiBlockLattice2D<T,Descriptor>& latticeFrom, MultiBlockLattice2D<T,Descriptor>& latticeTo,
                     Box2D domain)
{
    applyProcessingFunctional (
            new CopyPopulationsFunctional2D<T,Descriptor>(), domain, latticeFrom, latticeTo );
...
{
        applyProcessingFunctional ( new CopyConvertPopulationsFunctional2D<T1,Descriptor1,T2,Descriptor2>(), domain, latticeFrom, latticeTo );
}

template<typename T, template<typename U> class Descriptor>
void copyAll(MultiBlockLattice2D<T,Descriptor>& latticeFrom,
             MultiBlockLattice2D<T,Descriptor>& latticeTo, Box2D domain)
{
    applyProcessingFunctional (
            new LatticeCopyAllFunctional2D<T,Descriptor>(), domain, latticeFrom, latticeTo );
}
...
template<typename T, template<typename U> class Descriptor>
void copyRegenerate(MultiBlockLattice2D<T,Descriptor>& latticeFrom,
                    MultiBlockLattice2D<T,Descriptor>& latticeTo, Box2D domain)
{
    applyProcessingFunctional (
            new LatticeRegenerateFunctional2D<T,Descriptor>(), domain, latticeFrom, latticeTo );
...
{
    applyProcessingFunctional (
            new BoxOmegaFunctional2D<T,Descriptor>, domain, lattice, omega );
}
...
template<typename T, template<typename U> class Descriptor>
void computeExternalForce(MultiBlockLattice2D<T,Descriptor>& lattice,
                     MultiTensorField2D<T,Descriptor<T>::d>& force, Box2D domain)
{
    applyProcessingFunctional (
...
{
    applyProcessingFunctional (
            new A_lt_alpha_functional2D<T>(scalar), domain, field, result );
}
...
{
    applyProcessingFunctional (
            new A_gt_alpha_functional2D<T>(scalar), domain, field, result );
}
...
{
    applyProcessingFunctional (
    new ComputeScalarLogFunctional2D<T>, domain, A, result );
}
...
void lessThan(MultiScalarField2D<T>& A, MultiScalarField2D<T>& B, MultiScalarField2D<int>& result, Box2D domain)
{
    ...
    fields.push_back(&result);
    applyProcessingFunctional (
            new A_lt_B_functional2D<T>, domain, fields );
}
...
void greaterThan(MultiScalarField2D<T>& A, MultiScalarField2D<T>& B, MultiScalarField2D<int>& result, Box2D domain)
{
    ...
    fields.push_back(&result);
    applyProcessingFunctional (
            new A_gt_B_functional2D<T>, domain, fields );
}
