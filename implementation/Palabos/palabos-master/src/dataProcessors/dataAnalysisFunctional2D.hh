...
template<typename T, template<typename U> class Descriptor> 
CopyPopulationsFunctional2D<T,Descriptor>* CopyPopulationsFunctional2D<T,Descriptor>::clone() const
{
    return new CopyPopulationsFunctional2D<T,Descriptor>(*this);
}

template<typename T, template<typename U> class Descriptor> 
void CopyPopulationsFunctional2D<T,Descriptor>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
                                 ...
                                 BlockLattice2D<T2,Descriptor2>& latticeTo )
{
        ...
        for (plint iX=domain.x0; iX<=domain.x1; ++iX) {
                for (plint iY=domain.y0; iY<=domain.y1; ++iY) {
                        ...
                        latticeTo.get(iX+offset.x,iY+offset.y)[ipop]=(T2)latticeFrom.get(iX,iY)[ipop];
                }
        }
}
...
template<typename T1, template<typename U1> class Descriptor1, typename T2, template<typename U2> class Descriptor2> 
CopyConvertPopulationsFunctional2D<T1,Descriptor1, T2,Descriptor2>* CopyConvertPopulationsFunctional2D<T1,Descriptor1,T2,Descriptor2>::clone() const
{
    return new CopyConvertPopulationsFunctional2D<T1,Descriptor1,T2,Descriptor2>(*this);
}

template<typename T1, template<typename U1> class Descriptor1, typename T2, template<typename U2> class Descriptor2> 
void CopyConvertPopulationsFunctional2D<T1,Descriptor1,T2,Descriptor2>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
                      ...
                      BlockLattice2D<T,Descriptor>& latticeTo )
{
    ...
    for (plint iX=domain.x0; iX<=domain.x1; ++iX) {
        for (plint iY=domain.y0; iY<=domain.y1; ++iY) {
            latticeTo.get(iX+offset.x,iY+offset.y).attributeValues(latticeFrom.get(iX,iY));
            latticeTo.attributeDynamics(iX+offset.x,iY+offset.y,
                                       latticeFrom.get(iX,iY).getDynamics().clone());
            latticeTo.get(iX+offset.x,iY+offset.y).
                attributeValues(latticeFrom.get(iX,iY));
        }
    }
}

template<typename T, template<typename U> class Descriptor> 
LatticeRegenerateFunctional2D<T,Descriptor>* LatticeRegenerateFunctional2D<T,Descriptor>::clone() const
{
    return new LatticeRegenerateFunctional2D<T,Descriptor>(*this);
}

template<typename T, template<typename U> class Descriptor> 
void LatticeRegenerateFunctional2D<T,Descriptor>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
...
template<typename T, template<typename U> class Descriptor> 
void BoxDensityFunctional2D<T,Descriptor>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T, template<typename U> class Descriptor> 
void BoxRhoBarFunctional2D<T,Descriptor>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
{
    BlockLattice2D<T,Descriptor>& lattice = *dynamic_cast<BlockLattice2D<T,Descriptor>*>(fields[0]);
...
template<typename T, template<typename U> class Descriptor> 
void BoxRhoBarJfunctional2D<T,Descriptor>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
...
template<typename T, template<typename U> class Descriptor> 
void PackedRhoBarJfunctional2D<T,Descriptor>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;  // lattice
...
template<typename T, template<typename U> class Descriptor> 
void BoxKineticEnergyFunctional2D<T,Descriptor>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T, template<typename U> class Descriptor> 
void BoxVelocityNormFunctional2D<T,Descriptor>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T, template<typename U> class Descriptor> 
void BoxVelocityComponentFunctional2D<T,Descriptor>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T, template<typename U> class Descriptor> 
void BoxVelocityFunctional2D<T,Descriptor>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T, template<typename U> class Descriptor> 
void BoxPiNeqFunctional2D<T,Descriptor>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T, template<typename U> class Descriptor> 
void BoxShearStressFunctional2D<T,Descriptor>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T, template<typename U> class Descriptor> 
void BoxStrainRateFromStressFunctional2D<T,Descriptor>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T, template<typename U> class Descriptor> 
void BoxTemperatureFunctional2D<T,Descriptor>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T, template<typename U> class Descriptor> 
void BoxSoundSpeedFunctional2D<T,Descriptor>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T, template<typename U> class Descriptor> 
void BoxPopulationFunctional2D<T,Descriptor>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
        ...
        Box2D domain, BlockLattice2D<T,Descriptor>& lattice, ScalarField2D<T>& equilibrium)
{
    ...
    for (plint iX=domain.x0; iX<=domain.x1; ++iX) {
        for (plint iY=domain.y0; iY<=domain.y1; ++iY) {
            ...
            T jSqr = normSqr(j);
            equilibrium.get(iX+offset.x,iY+offset.y) = cell.computeEquilibrium(iComponent, rhoBar, j, jSqr);
        }
    }
}
...
template<typename T, template<typename U> class Descriptor> 
void BoxEquilibriumFunctional2D<T,Descriptor>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
void BoxAllPopulationsFunctional2D<T,Descriptor>::process (
        Box2D domain, BlockLattice2D<T,Descriptor>& lattice, TensorField2D<T,Descriptor<T>::q>& tensorField)
{
    Dot2D offset = computeRelativeDisplacement(lattice, tensorField);
    for (plint iX=domain.x0; iX<=domain.x1; ++iX) {
        for (plint iY=domain.y0; iY<=domain.y1; ++iY) {
...
template<typename T, template<typename U> class Descriptor> 
BoxAllPopulationsFunctional2D<T,Descriptor>* BoxAllPopulationsFunctional2D<T,Descriptor>::clone() const
{
    return new BoxAllPopulationsFunctional2D<T,Descriptor>(*this);
}

template<typename T, template<typename U> class Descriptor> 
void BoxAllPopulationsFunctional2D<T,Descriptor>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T, template<typename U> class Descriptor>
BoxAllPopulationsToLatticeFunctional2D<T,Descriptor>* BoxAllPopulationsToLatticeFunctional2D<T,Descriptor>::clone() const
{
    return new BoxAllPopulationsToLatticeFunctional2D<T,Descriptor>(*this);
}

template<typename T, template<typename U> class Descriptor>
void BoxAllPopulationsToLatticeFunctional2D<T,Descriptor>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
...
template<typename T, template<typename U> class Descriptor> 
void BoxOmegaFunctional2D<T,Descriptor>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T, template<typename U> class Descriptor>
BoxExternalForceFunctional2D<T,Descriptor>* BoxExternalForceFunctional2D<T,Descriptor>::clone() const
{
    return new BoxExternalForceFunctional2D<T,Descriptor>(*this);
}

template<typename T, template<typename U> class Descriptor>
void BoxExternalForceFunctional2D<T,Descriptor>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
void CopyConvertScalarFunctional2D<T1,T2>::process (
        Box2D domain, ScalarField2D<T1>& field1,
...
template<typename T1, typename T2>
void CopyConvertScalarFunctional2D<T1,T2>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T>
void ExtractScalarSubDomainFunctional2D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T>
void ComputeAbsoluteValueFunctional2D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T>
void ComputeScalarSqrtFunctional2D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T>
void ComputeScalarLogFunctional2D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T, int nDim>
void ComputeTensorSqrtFunctional2D<T,nDim>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T>
A_lt_alpha_functional2D<T>::A_lt_alpha_functional2D(T alpha_)
    : alpha(alpha_)
{ }
...
template<typename T>
A_gt_alpha_functional2D<T>::A_gt_alpha_functional2D(T alpha_)
    : alpha(alpha_)
{ }
...
template<typename T>
void A_minus_alpha_functional2D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T>
void Alpha_minus_A_functional2D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T>
void A_times_alpha_functional2D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T, int nDim>
Tensor_A_times_alpha_functional2D<T,nDim>* Tensor_A_times_alpha_functional2D<T,nDim>::clone() const {
    return new Tensor_A_times_alpha_functional2D<T,nDim>(*this);
}

template<typename T, int nDim>
void Tensor_A_times_alpha_functional2D<T,nDim>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T>
void A_dividedBy_alpha_functional2D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T>
void Alpha_dividedBy_A_functional2D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T>
void A_plus_alpha_inplace_functional2D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::staticVariables;
}
...
template<typename T>
void A_minus_alpha_inplace_functional2D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::staticVariables;
}
...
template<typename T>
void A_times_alpha_inplace_functional2D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::staticVariables;
}
...
template<typename T>
void A_dividedBy_alpha_inplace_functional2D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::staticVariables;
}
...
template<typename T>
void A_lt_B_functional2D<T>::processGenericBlocks (
        Box2D domain, std::vector<AtomicBlock2D*> fields )
{
...
template<typename T>
void A_gt_B_functional2D<T>::processGenericBlocks (
        Box2D domain, std::vector<AtomicBlock2D*> fields )
{
    PLB_PRECONDITION( fields.size()==3 );
    ScalarField2D<T>& A = *dynamic_cast<ScalarField2D<T>*>(fields[0]);
...
template<typename T>
void A_dividedBy_B_functional2D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::nothing;
    modified[2] = modif::staticVariables;
}
...
template<typename T>
void A_plus_B_inplace_functional2D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::staticVariables;
    modified[1] = modif::nothing;
}
...
template<typename T>
void A_minus_B_inplace_functional2D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::staticVariables;
    modified[1] = modif::nothing;
}
...
template<typename T>
void A_times_B_inplace_functional2D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::staticVariables;
    modified[1] = modif::nothing;
}
...
template<typename T>
void A_dividedBy_B_inplace_functional2D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::staticVariables;
    modified[1] = modif::nothing;
}
...
void CopyConvertTensorFunctional2D<T1,T2,nDim>::process (
        Box2D domain, TensorField2D<T1,nDim>& field1,
...
template<typename T1, typename T2, int nDim>
CopyConvertTensorFunctional2D<T1,T2,nDim>* CopyConvertTensorFunctional2D<T1,T2,nDim>::clone() const
{
    return new CopyConvertTensorFunctional2D<T1,T2,nDim>(*this);
}

template<typename T1, typename T2, int nDim>
void CopyConvertTensorFunctional2D<T1,T2,nDim>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T, int nDim>
void ExtractTensorSubDomainFunctional2D<T,nDim>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T, int nDim>
void ExtractTensorComponentFunctional2D<T,nDim>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::staticVariables;
    modified[1] = modif::nothing;
}
...
template<typename T, int nDim>
void ComputeNormFunctional2D<T,nDim>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::staticVariables;
    modified[1] = modif::nothing;
}
...
template<typename T, int nDim>
void ComputeNormSqrFunctional2D<T,nDim>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::staticVariables;
    modified[1] = modif::nothing;
}
...
template<typename T>
void ComputeSymmetricTensorNormFunctional2D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::staticVariables;
    modified[1] = modif::nothing;
}
...
template<typename T>
void ComputeSymmetricTensorNormSqrFunctional2D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::staticVariables;
    modified[1] = modif::nothing;
}
...
template<typename T>
void ComputeSymmetricTensorTraceFunctional2D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::staticVariables;
    modified[1] = modif::nothing;
}
...
template<typename T, int nDim>
void BoxBulkVorticityFunctional2D<T,nDim>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::staticVariables;
    modified[1] = modif::nothing;
}
...
template<typename T, int nDim>
void BoxVorticityFunctional2D<T,nDim>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::staticVariables;
    modified[1] = modif::nothing;
}
...
template<typename T, int nDim>
void BoxBulkStrainRateFunctional2D<T,nDim>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T, int nDim>
void BoxStrainRateFunctional2D<T,nDim>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T, int nDim>
void Tensor_A_plus_B_functional2D<T,nDim>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::nothing;
    modified[2] = modif::staticVariables;
}
...
template<typename T, int nDim>
void Tensor_A_minus_B_functional2D<T,nDim>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::nothing;
    modified[2] = modif::staticVariables;
}
...
template<typename T, int nDim>
void Tensor_A_times_B_functional2D<T,nDim>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::nothing;
    modified[2] = modif::staticVariables;
}
...
template<typename T, int nDim>
void Tensor_A_dividedBy_B_functional2D<T,nDim>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::nothing;
    modified[2] = modif::staticVariables;
}
...
template<typename T, int nDim>
void Tensor_A_plus_B_inplace_functional2D<T,nDim>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::staticVariables;
    modified[1] = modif::nothing;
}
...
template<typename T, int nDim>
void Tensor_A_minus_B_inplace_functional2D<T,nDim>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::staticVariables;
    modified[1] = modif::nothing;
}
...
template<typename T, int nDim>
void Tensor_A_times_B_inplace_functional2D<T,nDim>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::staticVariables;
    modified[1] = modif::nothing;
}
...
template<typename T, int nDim>
void Tensor_A_times_alpha_inplace_functional2D<T,nDim>::
...
template<typename T, int nDim>
void Tensor_A_dividedBy_B_inplace_functional2D<T,nDim>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::staticVariables;
    modified[1] = modif::nothing;
}
