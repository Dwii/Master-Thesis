...
template<typename T, template<typename U> class Descriptor>
void StoreDynamicsFunctional2D<T,Descriptor>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
...
template<typename T, template<typename U> class Descriptor>
ExtractDynamicsChainFunctional2D<T,Descriptor>* ExtractDynamicsChainFunctional2D<T,Descriptor>::clone() const {
    return new ExtractDynamicsChainFunctional2D<T,Descriptor>(*this);
}

template<typename T, template<typename U> class Descriptor>
void ExtractDynamicsChainFunctional2D<T,Descriptor>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T, template<typename U> class Descriptor>
void ExtractTopMostDynamicsFunctional2D<T,Descriptor>::
...
template<typename T, template<typename U> class Descriptor>
void ExtractBottomMostDynamicsFunctional2D<T,Descriptor>::
    getTypeOfModification(std::vector<modif::ModifT>& modified) const
{
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
    ...
    for (plint iX=domain.x0; iX<=domain.x1; ++iX) {
        for (plint iY=domain.y0; iY<=domain.y1; ++iY) {
            ...
            destinationLattice.attributeDynamics (
                    iX_,iY_, meta::dynamicsRegistration<T,Descriptor>().
...
template<typename T, template<typename U> class Descriptor>
AssignEntireCellFunctional2D<T,Descriptor>*
    AssignEntireCellFunctional2D<T,Descriptor>::clone() const
{
    return new AssignEntireCellFunctional2D<T,Descriptor>(*this);
}

template<typename T, template<typename U> class Descriptor>
void AssignEntireCellFunctional2D<T,Descriptor>::
    getTypeOfModification(std::vector<modif::ModifT>& modified) const
{
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
