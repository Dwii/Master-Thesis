...
{
public:
    virtual void process(Box2D domain, BlockLattice2D<T,Descriptor>& latticeFrom,
...
template<typename T, template<typename U> class Descriptor> 
class BoxAllPopulationsFunctional2D : public BoxProcessingFunctional2D_LT<T,Descriptor,T,Descriptor<T>::q>
{
public:
...
class CountTensorElementsFunctional2D :
    public ReductiveBoxProcessingFunctional2D_T<T,nDim>
{
public:
...
{
public:
    virtual void process(Box2D domain, TensorField2D<T1,nDim>& field1, TensorField2D<T2,nDim>& field2);
...
class ComputeSymmetricTensorNormFunctional2D :
    public BoxProcessingFunctional2D_ST<T,T,3>
{
public:
    virtual void process(Box2D domain, ScalarField2D<T>& scalarField,
...
class Tensor_A_times_alpha_inplace_functional2D :
    public BoxProcessingFunctional2D_T<T,nDim>
{
public:
