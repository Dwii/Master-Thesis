...
template<typename T, template<typename U> class Descriptor, class DensityFunction>
void SetCustomBoundaryDensityFunctional2D<T,Descriptor,DensityFunction>::
    execute(plint iX, plint iY, Cell<T,Descriptor>& cell) const
{
...
template<typename T, template<typename U> class Descriptor, class TemperatureFunction>
void SetCustomBoundaryTemperatureFunctional2D<T,Descriptor,TemperatureFunction>::
    execute(plint iX, plint iY, Cell<T,Descriptor>& cell) const
{
    // No rescaling needed: rho is scale invariant.
...
SetToScalarFunctionFunctional2D<T,Function>::SetToScalarFunctionFunctional2D(Function f_)
    : f(f_)
{ }

template<typename T, class Function>
void SetToScalarFunctionFunctional2D<T,Function>::process (
...
template<typename T, class Function>
SetToScalarFunctionFunctional2D<T,Function>*
    SetToScalarFunctionFunctional2D<T,Function>::clone() const
{
