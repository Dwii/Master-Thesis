...
void apply(BlockLattice2D<T,Descriptor>& lattice, Box2D domain, OneCellFunctional2D<T,Descriptor>* f);

template<typename T, template<class U> class Descriptor>
void applyIndexed(BlockLattice2D<T,Descriptor>& lattice, Box2D domain,
                  OneCellIndexedFunctional2D<T,Descriptor>* f);

template<typename T, template<class U> class Descriptor>
void defineDynamics(BlockLattice2D<T,Descriptor>& lattice, Box2D domain,
...
template<typename T, template<class U> class Descriptor>
void defineDynamics(BlockLattice2D<T,Descriptor>& lattice, plint iX, plint iY,
                    Dynamics<T,Descriptor>* dynamics);

template<typename T, template<class U> class Descriptor>
void defineDynamics(BlockLattice2D<T,Descriptor>& lattice, DotList2D const& dotList,
                    Dynamics<T,Descriptor>* dynamics);
...
template<typename T, template<class U> class Descriptor>
void defineDynamics(MultiBlockLattice2D<T,Descriptor>& lattice, plint iX, plint iY,
                    Dynamics<T,Descriptor>* dynamics);

template<typename T, template<class U> class Descriptor>
void defineDynamics(MultiBlockLattice2D<T,Descriptor>& lattice, DotList2D const& dotList,
                    Dynamics<T,Descriptor>* dynamics);
...
void setExternalVector( MultiBlockLattice2D<T,Descriptor>& lattice, Box2D domain,
                        int vectorStartsAt, VectorFunction f );
...
template<typename T>
void setToConstant(ScalarField2D<T>& field, ScalarField2D<int>& mask, int flag,
                   Box2D domain, T value);
...
///   the mask is equal to the flag.
template<typename T, int nDim>
void setToConstant( TensorField2D<T,nDim>& field, ScalarField2D<int>& mask, int flag,
                    Box2D domain, Array<T,nDim> const& value );
...
///   the mask is equal to the flag.
template<typename T>
void setToConstant(MultiScalarField2D<T>& field, MultiScalarField2D<int>& mask, int flag,
                   Box2D domain, T value);
...
///   the mask is equal to the flag.
template<typename T, int nDim>
void setToConstant( MultiTensorField2D<T,nDim>& field, MultiScalarField2D<int>& mask, int flag,
                    Box2D domain, Array<T,nDim> const& value );
