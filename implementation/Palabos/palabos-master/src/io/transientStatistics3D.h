...
public:
    ...
    TransientStatistics3D<T,Descriptor>& operator=(TransientStatistics3D<T,Descriptor> const& rhs);
...
private:
    ...
    int fieldOperationIsRegistered[numFields][numOperations];   // Table of all registered fields and operations.
