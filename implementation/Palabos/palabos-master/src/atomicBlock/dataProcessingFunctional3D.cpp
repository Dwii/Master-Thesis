...
BoxProcessorGenerator3D::BoxProcessorGenerator3D(BoxProcessingFunctional3D* functional_, Box3D domain)
    : BoxedDataProcessorGenerator3D(domain),
...
BoxProcessorGenerator3D::BoxProcessorGenerator3D(BoxProcessorGenerator3D const& rhs)
    : BoxedDataProcessorGenerator3D(rhs),
      functional(rhs.functional->clone())
{ }
...
DotProcessorGenerator3D::DotProcessorGenerator3D(DotProcessingFunctional3D* functional_, DotList3D const& dotList)
    : DottedDataProcessorGenerator3D(dotList),
      functional(functional_)
{ }
...
DotProcessorGenerator3D::DotProcessorGenerator3D(DotProcessorGenerator3D const& rhs)
    : DottedDataProcessorGenerator3D(rhs),
      functional(rhs.functional->clone())
{ }
...
BoundedBoxProcessingFunctional3D::BoundedBoxProcessingFunctional3D()
    : dxScale(0),
      dtScale(0)
{ }
