...
public:
    MultiBoxProcessor3D(BoxProcessingFunctional3D* functional_,
...
public:
    MultiBoxProcessorGenerator3D(BoxProcessingFunctional3D* functional_, std::vector<Box3D> const& domains);
