...
T computeBoundedAverage(MultiGridScalarField3D<T>& scalarField, Box3D domain) {
    ...
    applyProcessingFunctional(functional, domain, scalarField, scalarField.getReferenceLevel(), envelopeWidth);
...
template<typename T, template<typename U> class Descriptor>
std::auto_ptr<MultiGridLattice3D<T,Descriptor> > extractSubDomain(
        MultiGridLattice3D<T,Descriptor>& lattice, Box3D domain )
{
    MultiGridLattice3D<T,Descriptor>* extractedLattice = new MultiGridLattice3D<T,Descriptor>(lattice, domain);
    extractSubDomain(lattice, *extractedLattice, domain);
    return std::auto_ptr<MultiGridLattice3D<T,Descriptor> >(extractedLattice);
}
...
{
    applyProcessingFunctional (
            new BoxDensityFunctional3D<T,Descriptor>, domain, lattice, density,lattice.getReferenceLevel() );
}
...
std::auto_ptr<MultiGridScalarField3D<T> > computeDensity(MultiGridLattice3D<T,Descriptor>& lattice, Box3D domain)
{
    ...
    return std::auto_ptr<MultiGridScalarField3D<T> >(density);
}
...
{
    applyProcessingFunctional (
            new BoxRhoBarFunctional3D<T,Descriptor>, domain, lattice, rhoBar, lattice.getReferenceLevel() );
}
...
std::auto_ptr<MultiGridScalarField3D<T> > computeRhoBar(MultiGridLattice3D<T,Descriptor>& lattice, Box3D domain)
{
    ...
    return std::auto_ptr<MultiGridScalarField3D<T> >(rhoBar);
}
...
{
    applyProcessingFunctional (
            new BoxKineticEnergyFunctional3D<T,Descriptor>, domain, lattice, energy, lattice.getReferenceLevel() );
}
...
std::auto_ptr<MultiGridScalarField3D<T> > computeKineticEnergy(MultiGridLattice3D<T,Descriptor>& lattice, Box3D domain)
{
    ...
    return std::auto_ptr<MultiGridScalarField3D<T> >(energy);
}   
...
void computeVelocityNorm(
        MultiGridLattice3D<T,Descriptor>& lattice, MultiGridScalarField3D<T>& velocityNorm, Box3D domain )
{
    applyProcessingFunctional (
...
std::auto_ptr<MultiGridScalarField3D<T> > computeVelocityNorm(MultiGridLattice3D<T,Descriptor>& lattice, Box3D domain)
{
    ...
    return std::auto_ptr<MultiGridScalarField3D<T> >(velocityNorm);
}
                                                               ...
                                                               Box3D domain, plint iComponent)
{
    ...
    return std::auto_ptr<MultiGridScalarField3D<T> >(velocityComponent);
}

template<typename T, template<typename U> class Descriptor>
std::auto_ptr<MultiGridScalarField3D<T> > computeVelocityComponent(
...
{
    applyProcessingFunctional (
            new BoxVelocityFunctional3D<T,Descriptor>, domain, lattice, velocity, lattice.getReferenceLevel() );
}
...
Box3D domain)
{
    ...
    return std::auto_ptr<MultiGridTensorField3D<T,Descriptor<T>::d> >(velocity);
}
...
{
    applyProcessingFunctional (
        new BoxPiNeqFunctional3D<T,Descriptor>, domain, lattice, PiNeq, lattice.getReferenceLevel() );
}
...
computePiNeq(MultiGridLattice3D<T,Descriptor>& lattice, Box3D domain)
{
    ...
    return std::auto_ptr<MultiGridTensorField3D<T,SymmetricTensor<T,Descriptor>::n> >(PiNeq);
}
...
{
    applyProcessingFunctional (
            new BoxShearStressFunctional3D<T,Descriptor>, domain, lattice, stress, lattice.getReferenceLevel() );
}
...
{
    applyProcessingFunctional (
            new BoxStrainRateFromStressFunctional3D<T,Descriptor>, domain, lattice, S, lattice.getReferenceLevel() );
}
    ...
    computeStrainRateFromStress(MultiGridLattice3D<T,Descriptor>& lattice, Box3D domain)
{
    ...
    return std::auto_ptr<MultiGridTensorField3D<T,SymmetricTensor<T,Descriptor>::n> >(S);
}
...
{
    applyProcessingFunctional (
        new BoxPopulationFunctional3D<T,Descriptor>(iPop), domain, lattice, population,lattice.getReferenceLevel());
}
                                                        ...
                                                        Box3D domain, plint iPop)
{
    ...
    return std::auto_ptr<MultiGridScalarField3D<T> >(population);
}
...
{
    applyProcessingFunctional (
       new BoxAllPopulationsFunctional3D<T,Descriptor>(), domain, lattice, populations,lattice.getReferenceLevel());
}

template<typename T, template<typename U> class Descriptor>
std::auto_ptr<MultiGridScalarField3D<T> > computeAllPopulations(MultiGridLattice3D<T,Descriptor>& lattice,
                                                            Box3D domain)
{
    MultiGridTensorField3D<T,Descriptor<T>::q>* populations = 
            new MultiGridTensorField3D<T,Descriptor<T>::q>(lattice, domain);
    computeAllPopulations(lattice, *populations, domain);
    return std::auto_ptr<MultiGridTensorField3D<T,Descriptor<T>::q> >(populations);
}
...
template<typename T, template<typename U> class Descriptor>
void copyPopulations(MultiGridLattice3D<T,Descriptor>& latticeFrom, MultiGridLattice3D<T,Descriptor>& latticeTo,
                     Box3D domain)
{
    applyProcessingFunctional (
...
{
    applyProcessingFunctional (
            new ExtractScalarSubDomainFunctional3D<T>, domain, field, extractedField, field.getReferenceLevel() );
}
...
std::auto_ptr<MultiGridScalarField3D<T> > extractSubDomain(MultiGridScalarField3D<T>& field, Box3D domain)
{
    ...
    return std::auto_ptr<MultiGridScalarField3D<T> >(extractedField);
}
...
{
    applyProcessingFunctional (
            new A_minus_alpha_functional3D<T>(scalar), domain, field, result, field.getReferenceLevel() );
}
...
{
    applyProcessingFunctional (
            new Alpha_minus_A_functional3D<T>(scalar), domain, field, result, field.getReferenceLevel() );
}
...
{
    applyProcessingFunctional (
            new A_times_alpha_functional3D<T>(scalar), domain, field, result, field.getReferenceLevel() );
}
...
{
    applyProcessingFunctional (
            new A_dividedBy_alpha_functional3D<T>(scalar), domain, field, result, field.getReferenceLevel() );
}
...
{
    applyProcessingFunctional (
            new Alpha_dividedBy_A_functional3D<T>(scalar), domain, field, result, field.getReferenceLevel() );
}
...
void subtractInPlace(MultiGridScalarField3D<T>& field, T scalar, Box3D domain) {
    applyProcessingFunctional (
            new A_minus_alpha_inplace_functional3D<T>(scalar), domain, field, field.getReferenceLevel());
}
...
void multiplyInPlace(MultiGridScalarField3D<T>& field, T scalar, Box3D domain) {
    applyProcessingFunctional (
            new A_times_alpha_inplace_functional3D<T>(scalar), domain, field, field.getReferenceLevel());
}
...
void divideInPlace(MultiGridScalarField3D<T>& field, T scalar, Box3D domain) {
    applyProcessingFunctional (
            new A_dividedBy_alpha_inplace_functional3D<T>(scalar), domain, field, field.getReferenceLevel());
}
...
{
    applyProcessingFunctional (
            new CopyConvertScalarFunctional3D<T1,T2>, domain, field, convertedField, field.getReferenceLevel() );
}
...
std::auto_ptr<MultiGridScalarField3D<T2> > copyConvert(MultiGridScalarField3D<T1>& field, Box3D domain)
{
    ...
    return std::auto_ptr<MultiGridScalarField3D<T2> >(convertedField);
}
...
void add(MultiGridScalarField3D<T>& A, MultiGridScalarField3D<T>& B, MultiGridScalarField3D<T>& result, Box3D domain)
{
    ...
    applyProcessingFunctional (
            new A_plus_B_functional3D<T>, domain, fields, A.getReferenceLevel() );
}
...
domain)
{
    ...
    fields.push_back(&result);
    applyProcessingFunctional (
            new A_minus_B_functional3D<T>, domain, fields, A.getReferenceLevel() );
}
...
domain)
{
    ...
    fields.push_back(&result);
    applyProcessingFunctional (
            new A_times_B_functional3D<T>, domain, fields, A.getReferenceLevel() );
}
...
{
    MultiGridTensorField3D<T,nDim>* extractedField = new MultiGridTensorField3D<T,nDim>(field, domain);
    extractSubDomain(field, *extractedField, domain);
    return std::auto_ptr<MultiGridTensorField3D<T,nDim> >(extractedField);
}
...
int iComponent)
{
    applyProcessingFunctional (
            ...
            domain, component, tensorField, tensorField.getReferenceLevel() );
}
...
int iComponent)
{
    ...
    return std::auto_ptr<MultiGridScalarField3D<T> >(component);
}
...
template<typename T, int nDim>
void computeNorm(MultiGridTensorField3D<T,nDim>& tensorField, MultiGridScalarField3D<T>& component, Box3D domain)
{
    applyProcessingFunctional (
            new ComputeNormFunctional3D<T,nDim>, domain, component, tensorField, tensorField.getReferenceLevel() );
}
...
template<typename T, int nDim>
void computeNormSqr(MultiGridTensorField3D<T,nDim>& tensorField, MultiGridScalarField3D<T>& component, Box3D domain)
{
    applyProcessingFunctional (
            new ComputeNormSqrFunctional3D<T,nDim>, domain, component, tensorField, tensorField.getReferenceLevel() );
}
...
{
    applyProcessingFunctional (
            new ComputeSymmetricTensorNormFunctional3D<T>, domain, norm, tensorField, tensorField.getReferenceLevel() );
}
...
domain)
{
    ...
    return std::auto_ptr<MultiGridScalarField3D<T> >(norm);
}
...
{
    applyProcessingFunctional (
            new ComputeSymmetricTensorNormSqrFunctional3D<T>, 
            domain, normSqr, tensorField, tensorField.getReferenceLevel() );
}
...
domain)
{
    ...
    return std::auto_ptr<MultiGridScalarField3D<T> >(normSqr);
}
...
{
    applyProcessingFunctional (
            new ComputeSymmetricTensorTraceFunctional3D<T>,
            domain, trace, tensorField, tensorField.getReferenceLevel() );
}
...
domain)
{
    ...
    return std::auto_ptr<MultiGridScalarField3D<T> >(trace);
}
...
void computeVorticity(MultiGridTensorField3D<T,2>& velocity, MultiGridScalarField3D<T>& vorticity, Box3D domain)
{
    plint envelopeWidth=1;
    applyProcessingFunctional (
            new BoxVorticityFunctional3D<T,2>, 
            domain, vorticity, velocity, velocity.getReferenceLevel(), envelopeWidth );
}

template<typename T>
std::auto_ptr<MultiGridScalarField3D<T> > computeVorticity(MultiGridTensorField3D<T,2>& velocity, Box3D domain)
{
    MultiGridScalarField3D<T>* vorticity = new MultiGridScalarField3D<T>(velocity, domain);
    computeVorticity(velocity, *vorticity, domain);
    return std::auto_ptr<MultiGridScalarField3D<T> >(vorticity);
}
...
{
    applyProcessingFunctional (
            new BoxBulkVorticityFunctional3D<T,2>, domain, vorticity, velocity, velocity.getReferenceLevel() );
}
...
void computeStrainRate(MultiGridTensorField3D<T,2>& velocity, MultiGridTensorField3D<T,3>& S, Box3D domain)
{
    plint envelopeWidth=1;
    applyProcessingFunctional (
            new BoxStrainRateFunctional3D<T,2>, 
            domain, velocity, S, velocity.getReferenceLevel(), envelopeWidth );
}
...
std::auto_ptr<MultiGridTensorField3D<T,3> > computeStrainRate(MultiGridTensorField3D<T,2>& velocity, Box3D domain)
{
    ...
    return std::auto_ptr<MultiGridTensorField3D<T,3> >(S);
}
...
{
    applyProcessingFunctional (
            new BoxBulkStrainRateFunctional3D<T,2>, domain, velocity, S, velocity.getReferenceLevel() );
}
...
{
    applyProcessingFunctional (
            new CopyConvertTensorFunctional3D<T1,T2,nDim>, 
            domain, field, convertedField, field.getReferenceLevel() );
}

template<typename T1, typename T2, int nDim>
std::auto_ptr<MultiGridTensorField3D<T2,nDim> > copyConvert(MultiGridTensorField3D<T1,nDim>& field, Box3D domain)
{
    MultiGridTensorField3D<T2,nDim>* convertedField = new MultiGridTensorField3D<T2,nDim>(field, domain);
    copyConvert<T1,T2,nDim>(field, *convertedField, domain);
    return std::auto_ptr<MultiGridTensorField3D<T2,nDim> >(convertedField);
}
...
Box3D domain)
{
    ...
    add(A, B, *result, domain);
    return std::auto_ptr<MultiGridTensorField3D<T,nDim> >(result);
}
...
void multiplyInPlace(MultiGridTensorField3D<T,nDim>& A, T alpha, Box3D domain) {
    applyProcessingFunctional (
            new Tensor_A_times_alpha_inplace_functional3D<T,nDim>(alpha), domain, A, A.getReferenceLevel());
}
...
void divideInPlace(MultiGridTensorField3D<T,nDim>& A, MultiGridTensorField3D<T,nDim>& B, Box3D domain) {
    applyProcessingFunctional (
            new Tensor_A_dividedBy_B_inplace_functional3D<T,nDim>, domain, A, B, A.getReferenceLevel() );
}
