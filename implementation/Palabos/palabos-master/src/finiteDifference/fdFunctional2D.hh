...
template<typename T>
void BoxXderivativeFunctional2D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T>
void BoxYderivativeFunctional2D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T>
void BoxGradientNormFunctional2D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T>
BoxPoissonIteration2D<T>::BoxPoissonIteration2D(T beta_)
    : beta(beta_)
{ }
...
template<typename T>
void JacobiIteration2D<T>::processBulk (
        Box2D domain, std::vector<ScalarField2D<T>*> scalarFields )
{
    ScalarField2D<T> const& u_h     = *scalarFields[0];
    ScalarField2D<T>&       new_u_h = *scalarFields[1];
