...
template<typename T>
inline T bulkXderiv (
        ScalarField3D<T> const& field, plint iX, plint iY, plint iZ )
{
    T dxu = fd::ctl_diff( field.get(iX+1,iY,iZ),
...
inline T bulkYderiv (
        ScalarField3D<T> const& field, plint iX, plint iY, plint iZ )
{
    T dyu = fd::ctl_diff( field.get(iX,iY+1,iZ),
...
inline T bulkZderiv (
        ScalarField3D<T> const& field, plint iX, plint iY, plint iZ )
{
    T dzu = fd::ctl_diff( field.get(iX,iY,iZ+1),
...
inline T planeXderiv (
        ScalarField3D<T> const& field, int direction, int orientation,
        plint iX, plint iY, plint iZ )
{
    if (direction==0) {
        return -orientation *
            fd::o1_fwd_diff( field.get(iX              ,iY,iZ),
                             field.get(iX-1*orientation,iY,iZ) );
    }
    else {
        ...
        plint iX, plint iY, plint iZ )
{
    if (direction==1) {
        return -orientation *
            fd::o1_fwd_diff( field.get(iX,iY              ,iZ),
                             field.get(iX,iY-1*orientation,iZ) );
    }
    else {
        ...
        plint iX, plint iY, plint iZ )
{
    if (direction==2) {
        return -orientation *
            fd::o1_fwd_diff( field.get(iX,iY,iZ              ),
                             field.get(iX,iY,iZ-1*orientation) );
    }
    else {
...
template<typename T>
inline T bulkXderiv (
        ScalarField2D<T> const& field, plint iX, plint iY )
{
    T dxu = fd::ctl_diff( field.get(iX+1,iY),
                          field.get(iX-1,iY) );
    return dxu;
}
...
inline T bulkYderiv (
        ScalarField2D<T> const& field, plint iX, plint iY )
{
    T dyu = fd::ctl_diff( field.get(iX,iY+1),
                          field.get(iX,iY-1) );
    return dyu;
}
...
template<typename T>
inline T edgeXderiv (
        ScalarField2D<T> const& field, int direction, int orientation,
        plint iX, plint iY )
{
    if (direction==0) {
        return -orientation *
            fd::o1_fwd_diff( field.get(iX              ,iY),
                             field.get(iX-1*orientation,iY) );
    }
    else {
