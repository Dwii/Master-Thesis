...
static void compute_PiNeq(Array<T,Descriptor::q> const& f, T rhoBar, Array<T,2> const& j, Array<T,3>& PiNeq)
{
    T invRho = Descriptor::invRho(rhoBar);
...
static void compute_rhoBar_j_PiNeq(Array<T,Descriptor::q> const& f, T& rhoBar, Array<T,2>& j, Array<T,3>& PiNeq, T invRho)
{
    typedef SymmetricTensorImpl<T,2> S;
